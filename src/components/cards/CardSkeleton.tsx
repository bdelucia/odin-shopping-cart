export function ShopCardSkeleton() {
  return (
    <div className="flex flex-col bg-base-100 shadow-sm z-0 rounded-2xl animate-pulse">
      <figure className="h-48 w-full overflow-hidden bg-base-300 rounded-2xl"></figure>

...
function Card({ title, image, description, price, rating }: CardProps) {
  ...
  return (
    <div className="flex flex-col bg-base-100 w-64 sm:w-64 lg:w-72 shadow-sm z-0 rounded-2xl border-3 border-base-content hover:border-accent transition-colors duration-300">

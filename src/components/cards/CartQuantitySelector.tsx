...
function CartQuantitySelector({
  ...
  // Determine button styles and icon based on value
  const isMinQuantity = value === 1;
  const buttonClass = isMinQuantity
    ? 'join-item btn btn-error btn-soft border-error btn-xs sm:btn-xs md:btn-xs lg:btn-sm btn-square'
